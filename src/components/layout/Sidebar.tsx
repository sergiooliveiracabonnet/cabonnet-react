...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      {/* ── Status ── */}
      {sidebarOpen && (
        <div className="flex-shrink-0 mx-2 mb-2 rounded-lg px-3 py-2 bg-card-high border border-subtle">
      ...
      {/* ── User / Logout ── */}
      <div className="flex-shrink-0 px-2 pb-3 border-t border-subtle pt-2">
        {sidebarOpen ? (
          <div className="group flex items-center gap-2.5 rounded-lg px-3 py-2
                          bg-card-high border border-subtle hover:border-muted/30
