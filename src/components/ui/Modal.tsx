  ...
  return createPortal(
    ...
    >
      <div
        ...
        style={{ maxWidth }}
        className="w-full bg-card border border-subtle rounded-xl
                   flex flex-col overflow-hidden shadow-2xl max-h-[85vh]
                   animate-card-enter"
      >
        <div className="flex items-center gap-4 px-6 py-4 border-b border-subtle flex-shrink-0">
          <div className="flex-1 min-w-0">
            <p id="modal-title" className="font-headline font-bold text-title text-text">{title}</p>
