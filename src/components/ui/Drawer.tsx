    ...
    <>
      ...
      <div
        ...
        className={`fixed top-0 right-0 h-full flex flex-col z-drawer
                    bg-surface border-l border-subtle overflow-hidden
                    transition-transform duration-[380ms] ease-[cubic-bezier(.32,.72,0,1)]
                    will-change-transform
                    ${open ? 'translate-x-0' : 'translate-x-full'}`}
      >
        <div className="flex items-start gap-3 px-5 py-4 border-b border-subtle bg-card flex-shrink-0">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button
              ...
              onClick={handleClose}
              className="w-9 h-9 rounded-md border border-subtle flex items-center justify-center
        ...
        {footerActions && (
          <div className="flex items-center justify-end gap-2 px-5 py-3 border-t border-subtle bg-card flex-shrink-0">
            {footerActions}
          </div>
        )}
      </div>
