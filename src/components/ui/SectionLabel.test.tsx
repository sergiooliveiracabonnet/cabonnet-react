...
describe('SectionLabel', () => {
  it('renderiza o texto como heading', () => {
    render(<SectionLabel icon={Pulse} color="#a78bfa">Acompanhamento Diário</SectionLabel>)
  ...
  it('não aplica cor no texto do heading — só na barra/ícone', () => {
    render(<SectionLabel icon={Pulse} color="#a78bfa">Teste</SectionLabel>)
  ...
  it('renderiza a barra lateral com a cor recebida', () => {
    const { container } = render(<SectionLabel icon={Pulse} color="#a78bfa">Teste</SectionLabel>)
