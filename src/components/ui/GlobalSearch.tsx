  ...
  return (
    <>
      {open && (
        ...
        >
          <div className="w-full max-w-[600px] bg-elevated border border-subtle rounded-2xl shadow-2xl overflow-hidden animate-scale-in">
            <div className="flex items-center gap-3 px-4 py-3.5 border-b border-subtle">
              ...
              <kbd className="text-caption font-mono bg-surface border border-subtle
            ...
            <div className="max-h-[58vh] overflow-y-auto">
              {!query.trim() && (
                <div className="px-2 py-2">
                  ...
                  <div className="px-4 py-2.5 border-t border-subtle flex items-center gap-5 text-muted/50 mt-1">
                    {[
                      ...
                      <div key={label} className="flex items-center gap-1.5">
                        <div className="flex gap-1">
                          {keys.map((k, ki) => (
                            <kbd key={ki} className="text-caption font-mono bg-surface border border-subtle rounded px-1.5 py-0.5 leading-none text-muted/70">
                              {k}
                            </kbd>
                          ))}
                        </div>
                    ...
                    {results.os.map(os => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {isActive && (
                            <kbd className="text-caption font-mono bg-surface border border-subtle rounded px-1.5 py-0.5 flex-shrink-0 self-center text-muted leading-none">
                              <ArrowElbowDownLeft size={10} weight="bold" alt="Enter" />
                            </kbd>
                          )}
                        </button>
