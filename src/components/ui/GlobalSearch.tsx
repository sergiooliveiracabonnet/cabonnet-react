  ...
  return (
    <>
      {open && (
        ...
        >
          <div className="w-full max-w-[600px] bg-elevated border border-white/[0.12] rounded-2xl shadow-2xl overflow-hidden animate-scale-in">
            <div className="flex items-center gap-3 px-4 py-3.5 border-b border-white/[0.07]">
              ...
              <kbd className="text-[9px] font-mono bg-white/[0.06] border border-white/[0.10]
                  ...
                  <div className="flex flex-wrap gap-2 mb-8">
                    {HINT_TAGS.map(tag => (
                      <span key={tag} className="inline-flex items-center text-[11px] font-semibold px-2.5 py-1
                                                 bg-white/[0.05] border border-white/[0.09] rounded-full text-secondary">
                        {tag}
                      </span>
                    ))}
                  </div>
                    ...
                    {[
                      ...
                      <div key={label} className="flex items-center gap-1.5">
                        <div className="flex gap-1">
                          {keys.map(k => (
                            <kbd key={k} className="text-[9px] font-mono bg-white/[0.06] border border-white/[0.10] rounded px-1.5 py-0.5 leading-none text-muted/70">
                              {k}
                            </kbd>
                          ))}
                        </div>
                    ...
                    {results.map((os, idx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {isActive && (
                            <kbd className="text-[9px] font-mono bg-white/[0.08] border border-white/[0.12] rounded px-1.5 py-0.5 flex-shrink-0 self-center text-muted leading-none">
                              ↵
                            </kbd>
                          )}
                        </button>
