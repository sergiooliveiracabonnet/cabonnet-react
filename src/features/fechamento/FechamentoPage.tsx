    ...
    <div className="space-y-4 animate-fade-in">
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-md text-caption font-semibold transition-all duration-fast
                ${periodo === p.key
                  ...
                  : 'bg-bg text-secondary border border-subtle hover:bg-surface/40 hover:text-text'}`}
            >
              {p.label}
            </button>
          ))}
        ...
        {periodo === 'personalizado' && (
          <div className="flex flex-wrap items-center gap-2">
            <input
              ...
              className="px-2 py-1.5 rounded-md text-caption bg-bg border border-subtle text-text focus:outline-none focus:border-primary"
            />
      ...
      <div className="flex gap-2 justify-end pt-2">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-2 rounded-lg text-caption font-semibold
                     bg-card border border-subtle text-secondary hover:text-text hover:bg-surface/40 transition-all"
        >
    ...
    <div className="bg-card border border-subtle rounded-xl p-5">
      <div className="flex items-start justify-between gap-4 flex-wrap mb-4">
        ...
        <div className="flex gap-2 flex-shrink-0">
          ...
          <button onClick={onCSV}   className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-caption font-semibold bg-bg border border-subtle text-secondary hover:text-text transition-all">
            <DownloadSimple size={12} /> CSV
          </button>
          <button onClick={onPrint} className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-caption font-semibold bg-bg border border-subtle text-secondary hover:text-text transition-all">
