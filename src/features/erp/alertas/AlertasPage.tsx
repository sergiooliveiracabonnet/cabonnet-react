...
export default function AlertasPage() {
  ...
  return (
    <div className="space-y-4 max-w-[1600px]">
      ...
      <section aria-label="Filtros de alertas" className="rounded-xl border border-border bg-card p-3">
        <div className="flex flex-col lg:flex-row gap-3 lg:items-center">
          <label className="relative flex-1 min-w-0">
            ...
            <input value={search} onChange={event => setSearch(event.target.value)}
              ...
              className="w-full h-10 rounded-lg border border-border bg-surface pl-9 pr-3 text-label text-text outline-none focus-visible:ring-2 focus-visible:ring-primary/50" />
          </label>
          <div className="flex flex-wrap gap-2">
            ...
            <select id="alert-severity-filter" value={severityFilter} onChange={event => setSeverityFilter(event.target.value)}
              className="h-10 rounded-lg border border-border bg-surface px-3 text-label text-text outline-none focus-visible:ring-2 focus-visible:ring-primary/50">
