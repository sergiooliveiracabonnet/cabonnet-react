  ...
  return (
    <Modal open={open} onClose={onClose} title={title} maxWidth="780px">
      <div className="flex flex-col" style={{ maxHeight: '72vh' }}>
        <div className="flex items-center justify-between px-5 py-2.5 border-b border-subtle flex-shrink-0">
...
export function Section({ title, subtitle, action, children, height = 'h-64' }: {
  ...
  return (
    <div className="bg-elevated border border-subtle rounded-xl flex flex-col overflow-hidden">
