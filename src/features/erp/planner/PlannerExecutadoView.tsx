...
function TeamRow({ rank, entry, days, thisLen, prevLen, globalMax, isExpanded, onToggle, activeDayKey, onDayClick }: {
  ...
  return (
    <>
      ...
      <tr
        onClick={onToggle}
        className="border-b border-hairline hover:bg-surface/20 cursor-pointer transition-colors"
      >
        {/* Rank */}
      ...
      {isExpanded && (
        <tr className="border-b border-hairline bg-surface/15">
      ...
      <section className="space-y-2">
        ...
        {teams.length === 0 ? (
          ...
          <div className="rounded-2xl border border-subtle bg-card overflow-hidden">
            {/* Day header strip */}
            <div className="flex items-center gap-2 px-4 py-2 border-b border-hairline bg-surface/15">
              ...
              {aiProdutividade.analises && aiProdutividade.analises.length > 0 && (
                <div className="space-y-2">
                  {aiProdutividade.analises.map((a, i) => (
                    <div key={i} className="rounded-lg border border-hairline bg-surface/30 p-3 space-y-1">
                      <div className="flex items-center gap-2">
