    ...
    <section aria-label="Legenda do mapa" className="absolute bottom-2 right-2 z-[500] max-w-[calc(100%-1rem)] sm:bottom-4 sm:right-4">
      <details className="group rounded-xl border border-border-hover bg-elevated/95 shadow-xl backdrop-blur sm:open:min-w-56" open>
        ...
        <div className="space-y-2 border-t border-border px-3 pb-3 pt-2">
          ...
          <div className="border-t border-border pt-2 text-caption text-muted">Maior círculo = mais OS</div>
        ...
        {equipes.length > 0 && (
          <div className="px-4 py-3 border-b border-border">
            ...
            <div className="flex flex-wrap gap-1.5">
              {equipes.map(e => (
                <span key={e.nome} className="text-caption bg-surface/40 border border-border rounded-full px-2.5 py-1">
...
export function BairroPanel({ bairro, rows, onClose, onOS }: {
  ...
  return (
    <div className="absolute bottom-2 left-2 right-2 z-[500] animate-fade-in sm:bottom-4 sm:left-4 sm:right-auto sm:w-80">
      <div className="bg-elevated/95 backdrop-blur-md border border-border rounded-2xl overflow-hidden shadow-2xl flex flex-col max-h-[70vh]">
