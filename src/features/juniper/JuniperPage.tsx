    ...
    <div className="space-y-4 animate-fade-in">
      ...
      {interfaces.length > 0 && (
        <>
          ...
          {show3D && (
            <Suspense fallback={
              <div className="h-[520px] rounded-xl bg-card border border-subtle
      ...
      <div className="bg-card border border-subtle rounded-xl overflow-hidden shadow-lg">
        <div className="flex items-center gap-3 px-5 py-3.5 border-b border-subtle bg-surface/20 flex-wrap">
          ...
          <div className="flex items-center gap-2 ml-auto">
            ...
            <div className="flex bg-surface/30 border border-subtle rounded-md p-0.5 gap-0.5">
      ...
      <div className="bg-card border border-subtle rounded-xl overflow-hidden">
        ...
        <div className="divide-y divide-hairline min-h-[120px] max-h-[600px] overflow-y-auto">
          {historico.length === 0 ? (
