      ...
      >
        ...
        <div className="relative">
          ...
          <div className="px-5 py-4 space-y-4">
            ...
            {/* ── 1. Hero Status ───────────────────────────────────────── */}
            <div className="bg-surface/30 border border-subtle rounded-xl overflow-hidden">
            ...
            <Section label="Observações">
              ...
              {obsGeral ? (
                <div className="bg-surface/30 border border-subtle rounded-xl p-4">
            ...
            <Section label="Localização & Serviço">
              ...
              <button
                onClick={openMaps}
                className="w-full bg-surface/30 border border-subtle rounded-xl px-4 py-3
                           flex items-start gap-3 text-left hover:bg-surface/40 hover:border-subtle
    ...
    <button
      ...
      className={`w-8 h-8 rounded-xl border flex items-center justify-center transition-all duration-fast
                  ${active
                    ...
                    : 'border-subtle text-muted hover:text-text hover:bg-surface'}`}
    >
      {children}
    </button>
  )
