        ...
        <div className="flex-1 grid grid-cols-3 gap-4">
          {kpis.slice(0, 6).map(k => {
            ...
            return (
              <div
                key={k.id}
                className={`${acc.tint} bg-card border border-subtle rounded-xl
      ...
      <div className="flex flex-col gap-2.5 overflow-y-auto">
        ...
        {semaforo.map(eq => {
          ...
          return (
            <div
              key={eq.nome}
              className="flex items-center gap-3 bg-card border border-subtle
      ...
      <div className="flex-1 grid grid-cols-2 lg:grid-cols-3 gap-4 content-start">
        ...
        {fornecedores.map(f => {
          ...
          return (
            <div
              key={f.nome}
              className="bg-card border border-subtle rounded-xl p-5 flex flex-col gap-4"
  ...
  return (
    <div ref={containerRef} className="fixed inset-0 bg-bg text-text flex flex-col overflow-hidden">
      ...
      <header className="flex items-center gap-3 px-6 py-3
                         border-b border-subtle bg-elevated flex-shrink-0">
        {/* Live pulse */}
      ...
      {/* ── Footer ── */}
      <footer className="flex-shrink-0 bg-elevated border-t border-subtle px-6 py-2.5">
