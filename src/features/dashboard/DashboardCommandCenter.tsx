  ...
  return (
    ...
    >
        <header className="flex min-h-14 items-center justify-between gap-3 border-b border-border bg-bg/20 px-3 py-3 sm:px-4">
          ...
          <span className="inline-flex flex-shrink-0 items-center gap-1.5 rounded-full border border-subtle bg-surface/50 px-2 py-1 text-caption font-semibold text-secondary">
