  ...
  return (
    <div className="mt-4 pt-3 border-t border-hairline">
      <div className="flex items-center justify-between mb-1.5">
        <span className="text-caption font-bold uppercase tracking-label text-muted">Ritmo por turno hoje</span>
        {r.alerta && (
        ...
        <div className="flex items-start justify-between mb-3">
          ...
          {total > 0 && (
            <button
              ...
              className="text-caption text-muted hover:text-green border border-subtle
              ...
              {grupos.map(g => {
                ...
                return (
                  <button
                    ...
                    className="bg-surface/30 hover:bg-surface border border-subtle
