...
def test_parse_datetime_br_aceita_hora_sem_zero_padding():
    dt = _parse_datetime_br("22/06/2026 4:35")
    assert dt == datetime(2026, 6, 22, 4, 35)


def test_parse_datetime_br_rejeita_lixo_apos_a_hora():
    assert _parse_datetime_br("22/06/2026 14:35:99") is None
